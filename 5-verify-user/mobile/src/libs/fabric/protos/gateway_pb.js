...
import peer_chaincode_event_pb, { ChaincodeEvent } from './peer/chaincode_event_pb.js';
goog.object.extend(proto, peer_chaincode_event_pb);
import peer_proposal_pb, { SignedProposal } from './peer/proposal_pb.js';
goog.object.extend(proto, peer_proposal_pb);
import peer_proposal_response_pb, { Response } from './peer/proposal_response_pb.js';
goog.object.extend(proto, peer_proposal_response_pb);
import peer_transaction_pb from './peer/transaction_pb.js';
goog.object.extend(proto, peer_transaction_pb);
import common_common_pb, { Envelope } from './common/common_pb.js';
goog.object.extend(proto, common_common_pb);
import orderer_ab_pb, { SeekPosition } from './orderer/ab_pb.js';
...
proto.gateway.EndorseRequest = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.gateway.EndorseRequest.repeatedFields_, null);
};
goog.inherits(proto.gateway.EndorseRequest, Message);
...
goog.inherits(proto.gateway.EndorseResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.SubmitRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.SubmitResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.SignedCommitStatusRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.CommitStatusRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.CommitStatusResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.gateway.EvaluateRequest = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.gateway.EvaluateRequest.repeatedFields_, null);
};
goog.inherits(proto.gateway.EvaluateRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.EvaluateResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.SignedChaincodeEventsRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.ChaincodeEventsRequest, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.gateway.ChaincodeEventsResponse = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.gateway.ChaincodeEventsResponse.repeatedFields_, null);
};
goog.inherits(proto.gateway.ChaincodeEventsResponse, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.ErrorDetail, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.gateway.ProposedTransaction = function(opt_data) {
  Message.initialize(this, opt_data, 0, -1, proto.gateway.ProposedTransaction.repeatedFields_, null);
};
goog.inherits(proto.gateway.ProposedTransaction, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
goog.inherits(proto.gateway.PreparedTransaction, Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
...
proto.gateway.EndorseRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    transactionId: Message.getFieldWithDefault(msg, 1, ""),
    channelId: Message.getFieldWithDefault(msg, 2, ""),
    proposedTransaction: (f = msg.getProposedTransaction()) && SignedProposal.toObject(includeInstance, f),
    endorsingOrganizationsList: (f = Message.getRepeatedField(msg, 4)) == null ? undefined : f
  };
...
proto.gateway.EndorseRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new SignedProposal;
      reader.readMessage(value,SignedProposal.deserializeBinaryFromReader);
...
proto.gateway.EndorseRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      SignedProposal.serializeBinaryToWriter
    );
  }
...
proto.gateway.EndorseRequest.prototype.getProposedTransaction = function() {
  return /** @type{?proto.protos.SignedProposal} */ (
    Message.getWrapperField(this, SignedProposal, 3));
};
...
proto.gateway.EndorseResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    preparedTransaction: (f = msg.getPreparedTransaction()) && Envelope.toObject(includeInstance, f)
  };
...
proto.gateway.EndorseResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,Envelope.deserializeBinaryFromReader);
...
proto.gateway.EndorseResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      Envelope.serializeBinaryToWriter
    );
  }
};
...
proto.gateway.EndorseResponse.prototype.getPreparedTransaction = function() {
  return /** @type{?proto.common.Envelope} */ (
    Message.getWrapperField(this, Envelope, 1));
};
...
proto.gateway.SubmitRequest.prototype.getPreparedTransaction = function() {
  return /** @type{?proto.common.Envelope} */ (
    Message.getWrapperField(this, Envelope, 3));
};
...
proto.gateway.CommitStatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    blockNumber: Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.gateway.CommitStatusResponse.prototype.getResult = function() {
  return /** @type {!proto.protos.TxValidationCode} */ (Message.getFieldWithDefault(this, 1, 0));
};
...
proto.gateway.EvaluateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    channelId: Message.getFieldWithDefault(msg, 2, ""),
    proposedTransaction: (f = msg.getProposedTransaction()) && SignedProposal.toObject(includeInstance, f),
    targetOrganizationsList: (f = Message.getRepeatedField(msg, 4)) == null ? undefined : f
  };
...
proto.gateway.EvaluateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    result: (f = msg.getResult()) && Response.toObject(includeInstance, f)
  };
...
proto.gateway.EvaluateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,Response.deserializeBinaryFromReader);
      msg.setResult(value);
      break;
    default:
      reader.skipField();
...
proto.gateway.EvaluateResponse.prototype.getResult = function() {
  return /** @type{?proto.protos.Response} */ (
    Message.getWrapperField(this, Response, 1));
};
...
proto.gateway.ChaincodeEventsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    channelId: Message.getFieldWithDefault(msg, 1, ""),
    chaincodeId: Message.getFieldWithDefault(msg, 2, ""),
    identity: msg.getIdentity_asB64(),
    startPosition: (f = msg.getStartPosition()) && SeekPosition.toObject(includeInstance, f),
    afterTransactionId: Message.getFieldWithDefault(msg, 5, "")
  };
...
proto.gateway.ChaincodeEventsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new SeekPosition;
      reader.readMessage(value,SeekPosition.deserializeBinaryFromReader);
...
proto.gateway.ChaincodeEventsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      SeekPosition.serializeBinaryToWriter
    );
  }
...
proto.gateway.ChaincodeEventsRequest.prototype.getStartPosition = function() {
  return /** @type{?proto.orderer.SeekPosition} */ (
    Message.getWrapperField(this, SeekPosition, 4));
};
...
proto.gateway.ChaincodeEventsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    eventsList: Message.toObjectList(msg.getEventsList(),
    ChaincodeEvent.toObject, includeInstance),
    blockNumber: Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.gateway.ChaincodeEventsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new ChaincodeEvent;
      reader.readMessage(value,ChaincodeEvent.deserializeBinaryFromReader);
      msg.addEvents(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readUint64());
...
proto.gateway.ChaincodeEventsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      ChaincodeEvent.serializeBinaryToWriter
    );
  }
  f = message.getBlockNumber();
  if (f !== 0) {
...
proto.gateway.ChaincodeEventsResponse.prototype.getEventsList = function() {
  return /** @type{!Array<!proto.protos.ChaincodeEvent>} */ (
    Message.getRepeatedWrapperField(this, ChaincodeEvent, 1));
};
...
proto.gateway.ChaincodeEventsResponse.prototype.addEvents = function(opt_value, opt_index) {
  return Message.addToRepeatedWrapperField(this, 1, opt_value, proto.protos.ChaincodeEvent, opt_index);
};
...
proto.gateway.ErrorDetail.toObject = function(includeInstance, msg) {
  var f, obj = {
    address: Message.getFieldWithDefault(msg, 1, ""),
    mspId: Message.getFieldWithDefault(msg, 2, ""),
    message: Message.getFieldWithDefault(msg, 3, "")
  };
...
proto.gateway.ProposedTransaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    transactionId: Message.getFieldWithDefault(msg, 1, ""),
    proposal: (f = msg.getProposal()) && SignedProposal.toObject(includeInstance, f),
    endorsingOrganizationsList: (f = Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
...
proto.gateway.ProposedTransaction.prototype.getProposal = function() {
  return /** @type{?proto.protos.SignedProposal} */ (
    Message.getWrapperField(this, SignedProposal, 2));
};
...
proto.gateway.PreparedTransaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    transactionId: Message.getFieldWithDefault(msg, 1, ""),
    envelope: (f = msg.getEnvelope()) && Envelope.toObject(includeInstance, f)
  };
...
proto.gateway.PreparedTransaction.prototype.getEnvelope = function() {
  return /** @type{?proto.common.Envelope} */ (
    Message.getWrapperField(this, Envelope, 2));
};
